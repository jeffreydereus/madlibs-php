...
<form method="post" action="onkunde.php">
    <p id="First">Wat zou je graag willen kunnen? <input type="text" name="kunnen" required></p>
    ...
    <p id="Last">Wat is het ergste dat je kan overkomen? <input type="text" name="overkomen" required></p>
