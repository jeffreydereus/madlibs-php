...
<form method="post" action="paniek.php" class="formr">
    <p id="First">Welk dier zou je nooit als huisdier willen? <input type="text" name="dier" required></p>
    ...
    <p id="Last">Wat is je favoriete bezigheid? <input type="text" name="bezigheid" required></p>
    <input class="btnRegister2" type="submit" value="submit">
</form>